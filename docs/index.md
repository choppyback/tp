...
**PTCoach is a desktop application for managing your client's details.** While it has a GUI, most of the user interactions happen using a CLI (Command Line Interface).
