...
**`Main`** (consisting of classes [`Main`](https://github.com/AY2526S2-CS2103-F11-3/tp/blob/master/src/main/java/seedu/address/Main.java) and [`MainApp`](https://github.com/AY2526S2-CS2103-F11-3/tp/blob/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
The **API** of this component is specified in [`Ui.java`](https://github.com/AY2526S2-CS2103-F11-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java)
...
**API** : [`Logic.java`](https://github.com/AY2526S2-CS2103-F11-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java)
...
<puml src="diagrams/BetterModelClassDiagram.puml" width="780" />
...
**API** : [`Storage.java`](https://github.com/AY2526S2-CS2103-F11-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java)
...
* **Timeslots**: A field in a client which represents the timeslot allocated for training by the trainer
  - Consists of a list of `Timeslot` where each `Timeslot` consists of:
    ...
    - Slots (represented in `Slot` enumeration): in 24-hour format (HHMM-HHMM) from 0800 to 2000 **(start-end)** OR slot numbers (from 1 to 12) **(slotNumber)**
