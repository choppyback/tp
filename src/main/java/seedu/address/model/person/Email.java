...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
            ...
            + "1. Total length of the email must not exceed 200 characters.\n"
    ...
    private static final String CHAR_LIMIT_REGEX = "(?=.{1," + CHAR_LIMIT + "}$)";
    ...
    public static final String VALIDATION_REGEX = CHAR_LIMIT_REGEX + LOCAL_PART_REGEX + "@" + DOMAIN_REGEX + "";
