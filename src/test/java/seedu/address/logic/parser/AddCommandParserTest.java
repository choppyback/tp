...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTrainingGoal(VALID_TRAINING_GOAL_BOB).build();
    ...
    public void parse_repeatedValue_failure() {
        ...
        assertParseFailure(parser, AVAILABILITY_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_AVAILABILITY));
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + TRAINING_GOAL_DESC_AMY + AVAILABILITY_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_EMAIL, PREFIX_PHONE,
                        PREFIX_TRAINING_GOAL, PREFIX_AVAILABILITY));
        ...
        assertParseFailure(parser, INVALID_AVAILABILITY_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_AVAILABILITY));
        ...
        // invalid availability
        assertParseFailure(parser, validExpectedPersonString + INVALID_AVAILABILITY_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_AVAILABILITY));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + TRAINING_GOAL_DESC_BOB + VALID_TRAINING_GOAL_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB
                        + VALID_EMAIL_BOB + VALID_ADDRESS_BOB + VALID_TRAINING_GOAL_BOB + VALID_AVAILABILITY_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Email.MESSAGE_CONSTRAINTS);
